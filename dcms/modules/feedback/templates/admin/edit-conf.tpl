...
<table class="form">
	<tr>
		<td>Имя конфигурации:</td>
		<td><input type="text" name="confname" value="<{$conf->confname}>"></td>
	</tr>
	<tr>
...
<tr>
 ...
 <input type="submit" class="submit_update" value="#SAVE#">
		...
		<td><a class="delete_link" href="<{$run.me}>/delete-cause/csid_<{$cause.csid}>/">Удалить</a></td>
	</tr>
	<{/foreach}>
</table>
 ...
 <input type="submit" class="submit_update" value="#SAVE#">
		...
		<td><a class="delete_link" href="<{$run.me}>/delete-reply/rid_<{$reply.rid}>/">Удалить</a></td>
	</tr>
	<{/foreach}>
</table>
